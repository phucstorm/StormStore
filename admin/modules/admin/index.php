...
<div class="row"> 
	<div class="col-lg-12">    
		<h1>Admin User - Storm <a href="add.php" class="btn btn-success pull-right"><i class="fa fa-plus"> Add</i></a></h1>
		<ol class="breadcrumb">
						...
						<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%; text-align: center;">
							<thead>
								<tr role="row">
									...
									<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 180px;">Avatar</th>
							...
							<tbody>
								...
								<tr role="row" class="odd">
									<td><?php echo $stt ?></td>
									<td>
										<img src="/public/uploads/ad-img/<?php echo $item['avatar'] ?>" width="80px" height="80px" >
									</td>
