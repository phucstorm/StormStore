...
<div class="row" style="padding-left: 25%">
    <div class="col-lg-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="number" class="form-control" id="inputEmail3" name="sale" value="<?php echo $Editproduct['sale'] ?>">
            </div>
            ...
            <div class="col-sm-5">
                ...
                <?php endif ?>
                <img src="/public/uploads/product/<?php echo $Editproduct['thunbar'] ?>" width="300px" height="200px">
            </div>
        </div>
        <div class="form-group">
